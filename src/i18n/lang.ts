const en = {
  ...
  'explore.metrics.allTimeHigh.help': 'Record closing price for the instrument.',
  ...
  'explore.metrics.performanceDesc': 'Price evolution: 52-week range and all-time history.',
  'explore.metrics.riskTitle': 'Risk & Analyst Ratings',
  'explore.metrics.riskDesc': 'Market volatility and analyst consensus.',
  'explore.metrics.fundamentalsTitle': 'Fundamentals',
  'explore.metrics.fundamentalsDesc': 'Valuation, revenue, cash flow and financial structure.',
  ...
  'explore.metrics.fiftyTwoWeeksRange.help': 'Current price positioned against the 52-week low/high.',
  'explore.metrics.allTimeRange': 'All-time range',
  'explore.metrics.allTimeRange.help': 'Current price versus historical low/high.',
